module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, rev_request=false, app_sent=false, rent_payment_request=false, acceptance_request=false, sanitize_text=true, attachment=nil, message_timestamp = Time.now)
        ...
        message = Mailboxer::MessageBuilder.new({
          ...
          :body         => msg_body,
          :review_request => rev_request,
          :application_sent => app_sent,
          :rent_payment_request => rent_payment_request,
      ...
      def reply(conversation, recipients, reply_body, acceptance_request=false, subject=nil, sanitize_text=true, attachment=nil)
      ...
      def reply_to_conversation(conversation, reply_body, acceptance_request=false, subject=nil, should_untrash=true, sanitize_text=true, attachment=nil)
        ...
        reply(conversation, conversation.last_message.recipients, reply_body, acceptance_request, subject, sanitize_text, attachment)
      end
