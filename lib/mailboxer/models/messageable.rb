module Mailboxer
  module Models
    module Messageable
      ...
      #as originator
      def send_message(recipients, msg_body, subject, rev_request=false, app_sent=false, rent_payment_request=false, sanitize_text=true, attachment=nil, message_timestamp = Time.now)
